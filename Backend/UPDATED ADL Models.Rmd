...
AICselector <- function(Y_df, X_df, end_year, end_quarter){
...
ADL_predict_all <- function(Y_dataframe, X_dataframe, f_horizon){
  selectors_AIC <- AICselector(Y_dataframe, X_dataframe, end_y, end_q)
  ...
  if (f_horizon == 1){
    ...
    for (i in 2:f_horizon){
      ...
      selectors_AIC_local <- AICselector(gdp_ts, X_ts, upd_end_y, upd_end_q)
