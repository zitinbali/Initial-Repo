...
temp = matrix(coredata(GDPGrowth_ts), ncol = 1)

# AR order selection for GDP growth rate
models <- lapply(1:4, function(p) fitAR(temp, p, 2)$model)
...
# extract data from TS object for AR selection
temp = matrix(coredata(baa_aaa_ts), ncol = 1)
...
# extract data from TS object for AR selection
temp = matrix(coredata(tspread_ts), ncol = 1)
...
# extract data from TS object for AR selection
temp = matrix(coredata(fred_hstarts_ts), ncol = 1)
...
# extract data from TS object for AR selection
temp = matrix(coredata(consent_ts), ncol = 1)
