...
# Function for individual ADL Model
```{r}
AICselection_indv <- function(df, variable) {
  best_lag <- find_best_lag(df, "GDPGrowth_ts", variable, 4)
  formula <- extend_formula("GDPGrowth_ts ~ ", variable, best_lag)
  return(formula)
}
```
...
AICselection_indv(baa_aaa_ts, "baa_aaa_ts")
