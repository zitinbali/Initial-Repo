...
# ADL Model - Unemployment Insurance Claims

```{r adl model unemp}

unemp_prediction <- ADL_predict_all(GDPGrowth_ts, unemp_ts, example_fhorizon, covid_dummy)
ADL_predict_all(GDPGrowth_ts, unemp_ts, 1, covid_dummy)
ADL_predict_all(GDPGrowth_ts, unemp_ts, 2, covid_dummy)
ADL_predict_all(GDPGrowth_ts, unemp_ts, 3, covid_dummy)
ADL_predict_all(GDPGrowth_ts, unemp_ts, 4, covid_dummy)

```


# ADL Model - Yield Curve 

```{r adl model yield}

yield_prediction <- ADL_predict_all(GDPGrowth_ts, yield_ts, example_fhorizon, covid_dummy)
ADL_predict_all(GDPGrowth_ts, yield_ts, 1, covid_dummy)
ADL_predict_all(GDPGrowth_ts, yield_ts, 2, covid_dummy)
ADL_predict_all(GDPGrowth_ts, yield_ts, 3, covid_dummy)
ADL_predict_all(GDPGrowth_ts, yield_ts, 4, covid_dummy)
