...
ADL_predict_all <- function(Y_dataframe, X_dataframe, f_horizon){
  ...
  selectors_AIC <- AICselection_indv(X_dataframe, X_string, Y_string)
...
# model based on AIC selection
ADL_BAA_AAA <- 
  dynlm(as.formula(AICselection_indv(GDPGrowth_ts, "baa_aaa_ts", "GDPGrowth_ts")),
          start = c(start_y, start_q), 
          end = c(end_y, end_q))

BAA_AAA_selectors_AIC <- AICselection_indv(GDPGrowth_ts, "baa_aaa_ts", "GDPGrowth_ts")

# model further narrowed down based on p-values
BAA_AAA_selectors_p <- pval_selection_indv(ADL_BAA_AAA, "GDPGrowth_ts")
