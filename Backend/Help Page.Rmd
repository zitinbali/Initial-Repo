...
* You can also evaluate our models using the rolling test window. Select a quarter after the training window, and our rolling window model will predict growth rates up to that date.
...
* Using the Diebold-Marino test, we calculate the probability that the new model's results is better than that of the basic AR model.
