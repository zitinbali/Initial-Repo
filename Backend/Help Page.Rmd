...
* To determine anomalies, the algorithm highlights 3 different behaviours, leveraging concepts of the Median Average Deviation (MAD) and the median value:
  ...
  + When any of the growth rates of at least 2 ADL indicators from the past 4 quarters are separated from the median value of their individual indicator by a value greater than 2 x MAD. This is also indicated as a "medium deviation". 
