...
* If you would like to test your own ADL indicator, you may upload it under the "Add a Predictor" tab. 
  + The data should only have two columns, with the left being quarters formatted as “YYYY QQ” and the left being the GDP growth rates. Please refer to the sample file under the "Add a Predictor" tab for reference. 
...
* The output graph comprises recent actual growth rates, and an additional red line depicting the predicted growth rate. 
...
* If there is a [INSERT COLOUR NAME] shaded block in the window, that denotes a recession period in the past.
