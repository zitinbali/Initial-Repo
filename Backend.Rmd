...
prep_func = function(dataset, row_range, col_range){
...
post_prep_gdp <- prep_func(dataset, row_range, col_range)
...
post_prep_hstart <- prep_func(hstarts, hstart_row_range, hstart_col_range)
